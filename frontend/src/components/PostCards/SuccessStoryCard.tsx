import { Heart, MessageCircle, Share2, Bookmark, CheckCircle, AlertCircle, BookOpen, Clock } from 'lucide-react';
...
export function SuccessStoryCard({ post, liked, saved, onLike, onSave }: SuccessStoryCardProps) {
  return (
    <motion.div
    ...
    >
          ...
          <div className="flex items-center gap-2 text-sm text-green-600 bg-green-50 px-3 py-1.5 rounded-full shadow-sm">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <button className="text-xs text-green-700 underline">Details</button>
              </HoverCardTrigger>
      ...
      <div className="p-4">
        ...
        {post.taggedDoctors && post.taggedDoctors.length > 0 && (
          <div className="mb-4">
            <h4 className="text-sm font-medium text-gray-700 mb-2">Tagged Doctors:</h4>
