      ...
      try {
        ...
        const mockStories: SuccessStoryPost[] = [
          ...
          },
          {
            ...
            content: 'After being dismissed by conventional doctors, Dr. Sharma identified my condition as Vata imbalance. The prescribed routine and herbs gave me my energy back within 3 months.',
    ...
    <div className="min-h-screen w-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Your Tagged Success Stories</h1>
