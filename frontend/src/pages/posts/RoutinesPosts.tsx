...
import { Button, Typography, Box, Container, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, Snackbar, Alert, TextField } from "@mui/material";
...
export function AllRoutinePosts() {
  ...
  const [routinePosts, setRoutinePosts] = useState<RoutinePostType[]>([
    {
      ...
      content: "This daily routine helps balance all three doshas and sets you up for a productive, healthy day. Follow these steps within 30 minutes of waking for maximum benefits.",
      ...
      activities: [
        ...
        {
          time: "6:15 AM",
          content: "Yoga & Pranayama: 20 minutes of sun salutations and breathing exercises"
        },
        {
          time: "6:45 AM",
    ...
    },
    {
      ...
      content: "This cooling evening routine helps calm Pitta dosha after a long day. Perfect for hot summer months or when feeling irritable/overheated.",
    ...
    },
    {
      ...
      content: "This energizing routine helps combat winter lethargy and keeps Kapha dosha in balance during cold, damp months.",
  ...
  const handleShare = (post: RoutinePostType) => {
    navigator.clipboard.writeText(`Check out this routine: ${post.title}\n\n${post.content.substring(0, 100)}...`);
  ...
  const handleDelete = (postId: string) => {
    setRoutinePosts(prevPosts => prevPosts.filter(post => post.id !== postId));
