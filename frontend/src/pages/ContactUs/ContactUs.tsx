            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                ...
                <Box>
                  ...
                  <Typography variant="body1" fontWeight={500}>Sahyadri College of Engineering & Management, Mangalore</Typography>
                </Box>
              </Box>
            </Box>
          </Paper>
        ...
        >
          <Paper elevation={isMobile ? 0 : 6} sx={{ 
            ...
            <Typography 
              ...
              gutterBottom 
              sx={{
                background: (theme && theme.palette && theme.palette.primary && theme.palette.primary.main && theme.palette.secondary && theme.palette.secondary.main)
            ...
            <Typography variant="body1" color="text.secondary" mb={4} sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }}>
              Have questions, suggestions, or looking to collaborate? Reach out to us directly and we'll get back to you as soon as possible.
            </Typography>
            <ContactUsForm />
          </Paper>
        </motion.div>
