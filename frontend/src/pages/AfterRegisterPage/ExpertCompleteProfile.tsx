...
const ExpertCompleteProfile: React.FC = () => {
  ...
  const onSubmit = (data: VaidyaFormData) => {
  ...
  return (
    ...
    <div className="max-w-3xl w-screen mx-auto p-8 bg-white shadow-lg rounded-lg">
      <h2 className="text-3xl font-semibold mb-6 text-center text-green-800">Complete Your Vaidya Profile</h2>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
        {['fullName', 'email', 'phone', 'clinicAddress', 'specialization', 'experience'].map((field) => (
            <FormField
              key={field}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea rows={4} placeholder="Tell us about your Ayurvedic journey..." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="pt-4 text-center">
            <Button type="submit" variant="contained" color="success" size="large" startIcon={<SaveIcon />}>
              Save Profile
            </Button>
          </div>
        </form>
